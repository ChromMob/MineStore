...
public class ConnectionPool {
    ...
    private void setupPool() {
        ...
        if (MySQLData.getMethod() == ModeDatabase.MYSQL) {
        ...
        if (MySQLData.getMethod() == ModeDatabase.MARIADB) {
            config.setJdbcUrl(
                    "jdbc:mariadb://" +
                            hostname +
                            ":" +
    ...
    private static void update(User user) {
        ...
        try {
            ...
            Bukkit.getLogger().info("[MineStore] Error handler " + uuid + " " + username + " " + prefix + " " + suffix + " " + group);
        }
        finally {
            close(conn, ps, null);
        }
